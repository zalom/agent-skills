# Author a subagent or agent role file
...
```
description: >
  Use when a design doc is complete and needs an adversarial review before implementation.
  Use proactively after the design-specialist writes the doc.
  <example>
    Context: the design doc just landed for the current feature.
    user: "Is this design ready to build?"
    assistant: "I'll use the design-reviewer agent to challenge the doc before implementation."
    <commentary>Adversarial review runs before implementation begins.</commentary>
  </example>
```
